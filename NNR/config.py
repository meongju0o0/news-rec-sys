...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--epoch', type=int, default=16, help='Training epochs')
        ...
        # Model config
        parser.add_argument('--graph_entity_embedding_dim', type=int, default=768, help='Graph entity embedding dimension')
        parser.add_argument('--graph_entity_hidden_dim', type=int, default=384, help='Graph entity hidden dimension')
